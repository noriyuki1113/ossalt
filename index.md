...
- [[mattermost]] — Slack代替の最有力候補。セルフホスト・Slackインポート対応 (更新: 2026-04-09)
- [[rocketchat]] — Slack代替。オムニチャンネル・カスタマーサポート用途に強み (更新: 2026-04-09)
- [[zulip]] — Slack代替。スレッドファースト・非同期コミュニケーション特化 (更新: 2026-04-09)
- [[penpot]] — Figma代替。SVGネイティブ・セルフホスト可能なUIデザインツール (更新: 2026-04-09)
- [[inkscape]] — Figma/Illustrator代替。印刷・SVGイラスト用途のベクターエディタ (更新: 2026-04-09)
- [[plane]] — Jira代替。スプリント・バックログ・ロードマップをOSSで実現 (更新: 2026-04-09)
- [[vikunja]] — Asana/Todoist代替。軽量セルフホスト型タスク管理 (更新: 2026-04-09)
- [[appflowy]] — Notion/Asana代替。Rust製オフラインファースト・ワークスペース (更新: 2026-04-09)
- [[affine]] — Notion代替。ドキュメント＋ホワイトボード統合のKnowledgeOS (更新: 2026-04-09)
- [[anytype]] — Notion代替。P2P同期・オンデバイス暗号化の個人知識管理ツール (更新: 2026-04-09)
- [[outline]] — Notion/Confluence代替。チームWiki・ナレッジベース特化 (更新: 2026-04-09)
- [[nocodb]] — Airtable代替。既存DBにスプレッドシートUIを追加するOSS (更新: 2026-04-09)
- [[baserow]] — Airtable代替。ゼロ構築ノーコードDB・プラグイン拡張対応 (更新: 2026-04-09)
- [[teable]] — Airtable代替。PostgreSQLネイティブの大量データ対応ノーコードDB (更新: 2026-04-09)

## 比較記事（wiki/comparisons/）

- [[figma-vs-penpot]] — Figma代替文脈でのPenpot vs Inkscape比較 (confidence: medium, 更新: 2026-04-09)
...
- [[self-host-difficulty]] — セルフホスト難易度。導入・維持コストの総量 (更新: 2026-04-09)
- [[ops-burden]] — 運用負荷。セルフホスト移行後の継続コスト (更新: 2026-04-09)
- [[migration-friction]] — 移行摩擦。SaaS→OSS移行の総コスト (更新: 2026-04-09)
- [[local-first-offline]] — ローカルファースト・オフライン性。データ所有権と可用性 (更新: 2026-04-09)
