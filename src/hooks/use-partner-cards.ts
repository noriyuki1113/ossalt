...
/**
 * Fetch active partner/affiliate cards for a specific tool.
 *
 * Matches against partner_cards.tool_slug_or_category using two identifiers:
 *   - The tool's numeric ID as a string (e.g. "123")
 *   - A slug derived from the tool's name  (e.g. "app-flowy" from "AppFlowy")
 *
 * Cards are ordered by priority DESC so the highest-priority card is first.
 */
