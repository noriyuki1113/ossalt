...
const FAQ_ITEMS = [
  ...
  { q: "掲載ツールは無料ですか？", a: "多くは無料で使えますが、クラウド版は有料プランもあります。セルフホストなら基本無料です。" },
  { q: "セルフホストとは何ですか？", a: "自分のサーバーやクラウド環境でソフトウェアを運用することです。データを自社管理でき、自由にカスタマイズできます。" },
  { q: "日本語未対応のツールもありますか？", a: "はい。海外製OSSが多いため日本語未対応のものもあります。当サイトの説明文は日本語で提供しています。" },
  { q: "ツール掲載をリクエストできますか？", a: "はい。お問い合わせページからGitHubリポジトリのURLをお送りください。" },
];
