  ...
  return (
    <SiteLayout>
      <div className="container py-10">
        ...
        <p className="mt-2 text-muted-foreground">オープンソースの代替サービスを検索・比較</p>

        <div className="mt-6 space-y-4">
          <SearchInput value={searchQuery} onChange={setSearchQuery} placeholder="ツール名で検索..." className="max-w-lg" />
